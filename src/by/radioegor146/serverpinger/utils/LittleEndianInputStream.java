...
public class LittleEndianInputStream extends FilterInputStream {
    ...
    /**
     * Reads a <code>boolean</code> from the underlying input stream by reading
     * a single byte. If the byte is zero, false is returned. If the byte is
     * positive, true is returned.
     *
    ...
    /**
     * Reads a signed <code>byte</code> from the underlying input stream with
     ...
     * stream. This method blocks until all the bytes are skipped, the end of
